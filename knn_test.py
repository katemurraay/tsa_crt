    ...
    for t in targets:
        for c in cryptos:
            ...
            for index, r in enumerate(retrain):
                ...
                experiment_name = 'knn-' + c + '-' + t  + '-w' + str(window) +  '-h' + str(h) + '-' + str(len(outputs)) +'m'
                ...
                if tuned:
                    parameters = pd.read_csv("param/p_KNN-"+t+ '-'+c +"-w30-h0.csv").iloc[0] 
                    p = {'n_neighbors': parameters['n_neighbors'],
