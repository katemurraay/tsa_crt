        ...
        for res in resources:
            for h in horizons:
                for c in clusters:
                    ...
                    ds.build_crypto_dataset(f"{c.upper()}USD", '2016', '2022', f"{c.upper()}USDT", '1 Jan, 2013', '31 May, 2022')
                    ds.dataset_creation()
                    ds.dataset_normalization(['minmax'])  # , 'standard'])
                    ds.data_summary()
...
def total_test(wins, horizons, resources, clusters, model_name, scaling):
...
def tft_test(wins, horizons, resources, clusters, model_name, scaling):
...
#for d in ml_names: total_test(wins = [30], horizons = [0], resources = ['close'], clusters = ['btc','eth','ltc','xrp','xmr'], model_name = d, scaling=['minmax'])

tft_test(wins = [30], horizons = [0], resources = ['close'], clusters = ['eth'], model_name ='TFT', scaling=['minmax'])
...
#dataset_binance_test(wins = [1], horizons = [0], resources = ['close'], clusters = ['eth'])
...
#ts_stacked_test(wins = [1], horizons = [0], resources = ['close'], clusters = ['btc','eth','ltc','xrp','xmr'], model_name ='TFT', scaling=['minmax'], clist= clist)
